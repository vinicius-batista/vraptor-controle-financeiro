      ...
      <div class="w-4/5 lg:w-1/2 shadow-md rounded">
        ...
        <form action="/controle-financeiro/auth/cadastrar" class="bg-white px-8 pt-6 pb-8">
          ...
          <div class="mb-6 flex">
            ...
            <input
              class="bg-grey-lighter w-4/5 appearance-none shadow border-2 border-grey-lighter rounded w-full py-2 px-4 mr-5 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-blue-light"
              id="senha"
              name="usuario.senha"
              type="password"
              placeholder="******************"
